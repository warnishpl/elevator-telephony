...
export function AuthPanel({
	...
	const authOptions: { [key in Option]: {fields: InputField, finalComponent: JSX.Element } } = {
		[Option.Email]: {
			fields: {
				option: Option.Email,
				id: 'email',
		...
		[Option.Phone]: {
            ...
            finalComponent: <AuthPhone inputError={inputError} verificationCode={verificationCode} setVerificationCode={setVerificationCode} handleCodeSubmit={handleCodeSubmit}/>
		},
	};
